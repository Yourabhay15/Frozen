...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var email, password, hashedPassword, existingAdmin, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    ;
                    return [4 /*yield*/, bcryptjs_1.default.hash(password, 10)]; // 10 is the salt rounds
                case 1:
                ...
                case 8:
                    e_1 = _a.sent();
                    console.error("Error seeding admin user:", e_1);
                    process.exit(1);
                    return [3 /*break*/, 11];
